...
# mount C and D drives
echo "mounting C and D drives to /c and /d..."

cd / # necessary or else it will just create /c and /d at pwd
...
# default cd
# commented because this screws up "right click" behavior from File Explorer
# echo "cd /d/Desktop"
# cd /d/Desktop
cd $og_pwd

# enter tmux by default (if not already in tmux)
# commented because tmux starts up quite slow in cygwin
# if [[ ! "$TERM" =~ tmux ]] ; then
#   echo "tmux"
#   tmux
# fi
